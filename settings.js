...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=mrpyHAII#lcCU9M3MhiL7CGv6nNJ2EJkAc4Qx1IIinzC2fuQNvzQ' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*මම ඔන්ලයින් යකෝ" : process.env.ALIVE_MSG,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? 'කෑවද බන්' : process.env.DELETEMSGSENDTO,
